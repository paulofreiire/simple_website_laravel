...
@section('content')
    ...
    <header id="fh5co-header" class="fh5co-cover"
            style="background-image:url(public/front/assets/images/bg_1.jpeg); background-position: center bottom !important; background-attachment: fixed !important;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-push-5 animate-box">
                        <img class="img-responsive" src="{{url('front/assets/images/work_1.png')}}" alt="work">
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="fh5co-blog animate-box">
                            <a href="{{route('article', $post->uri)}}"><img class="img-responsive"
                                                                            src="{{url(\App\Support\Cropper::thumb($post->cover, 800, 450))}}"
                                                                            alt="image-{{$post->id}}"></a>
                            <div class="blog-text">
