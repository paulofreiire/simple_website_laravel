...
@section('content')
    ...
    <header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(public/front/assets/images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
            ...
            <div class="row">
                <div class="col-md-5 col-md-push-1 animate-box">
                    ...
                    <div class="fh5co-contact-info">
                        ...
                        <ul>
                            <li class="address">RUA, <br> COMPLEMENTO, <br> FORTALEZA/CE</li>
                            <li class="phone"><a href="tel://1234567920">TELEFONE</a></li>
                            <li class="email"><a href="mailto:paulo.freiire@hotmail.com">blz</a></li>
                        </ul>
                    </div>
